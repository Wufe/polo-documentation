...
If you want to look for a list of available options you may want to head to the [example-configuration.yml](https://github.com/wufe/polo-testserver) file.
...
These variables get created when executing start or stop commands.  
...
Commands are separted into start commands and stop commands.  
The former get called when starting a session and the latter when stopping it.  
